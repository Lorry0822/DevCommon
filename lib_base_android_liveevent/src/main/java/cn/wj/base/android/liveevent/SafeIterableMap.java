...
public class SafeIterableMap<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    /**
     * @return an ascending iterator, which doesn't include new elements added during an iteration.
     */
    @NonNull
    @Override
    ...
    /**
     * @return an descending iterator, which doesn't include new elements added during an iteration.
     */
